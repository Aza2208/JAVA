...
public class CreateOptionsForAdminImpl implements com.company.Untilty.CreateOptionsForAdmin {
    @Override
    public String createOptionsForAdmin() {
        // block 2
